...
/// Profile screen matching the MindMate design.
///
/// Layout:
/// - "Profile" title + gear icon
/// - Purple banner card with avatar, name, username, edit icon
/// - Stats row: Gender, Age, Birthday
/// - Registered date
/// - Data Management section (Activity History, Progress Insights, Reset Progress)
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            // ── Registered date + decorative dots ──
            Padding(
