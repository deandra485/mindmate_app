...
class _PuzzleDetailScreenState extends State<PuzzleDetailScreen>
    ...
    return Scaffold(
      ...
      body: Consumer<AppProvider>(
        builder: (context, provider, _) {
          final isUnlocked = provider.isPuzzleUnlocked(widget.puzzle.id);
                      ...
                      children: [
                        ...
                        if (isUnlocked)
                          ...
                          _LockedActions(
                            ...
                            userCoins: provider.user.coins,
                            onUnlock: () => _handleUnlock(context, provider),
                          ),
                      ],
                    ),
                  ),
  ...
  void _handleUnlock(BuildContext context, AppProvider provider) {
    final success =
        provider.unlockPuzzle(widget.puzzle.id, widget.puzzle.coinCost);
    if (success) {
