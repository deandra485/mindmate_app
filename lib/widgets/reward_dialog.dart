...
void showRewardDialog(BuildContext context, {int coins = 10, bool showPuzzleReward = false}) {
  showDialog(
    context: context,
    builder: (ctx) => _RewardDialog(coins: coins, showPuzzleReward: showPuzzleReward),
  );
}
...
class _RewardDialog extends StatelessWidget {
  ...
  const _RewardDialog({required this.coins, this.showPuzzleReward = false});
