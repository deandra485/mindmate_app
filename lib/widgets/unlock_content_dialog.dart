...
class UnlockContentDialog extends StatelessWidget {
  ...
  Future<void> _launchApp(BuildContext context) async {
    ...
    if (appProvider.user.coins < coinPrice) {
    ...
    appProvider.spendCoins(coinPrice);
    Navigator.pop(context);
  ...
  Widget build(BuildContext context) {
    final userCoins = Provider.of<AppProvider>(context).user.coins;
                              ...
                              child: imagePath != null
                                  ? ClipRRect(
                                      ...
                                      child: Image.asset(imagePath!, width: 48, height: 48, fit: BoxFit.cover,
                                        errorBuilder: (_, __, ___) => Center(child: Icon(icon, color: iconColor, size: 24)),
                                      ),
                                    )
